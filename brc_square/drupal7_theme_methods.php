...
$art_style = '';
$art_head = '';
function brc_square_process_html(&$variables) {
...
function brc_square_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function brc_square_button($variables) {
 ...
 */
function brc_square_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function brc_square_menu_local_task($variables) {
 ...
 */
function brc_square_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function brc_square_node_preview($variables) {
  $node = $variables['node'];
...
*/
function brc_square_form_alter(&$form, &$form_state, $form_id) {
...
function brc_square_form_element_label($variables) {
...
function brc_square_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function brc_square_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
